const contractAddress = "0xb4FA2e39f8d5254FA18d6E92cA19936A064c52a3"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the GeniePigs NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The GeniePigs NFT Project is a decentralized, open-source project that aims to save lives and make wishes come true by donating half of the NFT sales to <a href="https://savethechildren.org" target="new">Save The Children foundation</a>';
const h1_presale_coming_soon = "NFT Pre-Sale Drop Coming Soon!!";
